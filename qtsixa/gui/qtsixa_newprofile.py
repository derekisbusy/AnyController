...
class NewProfileW(QDialog, ui_qtsixa_newprofilew.Ui_NewProfileW):
    ...
    def __init__(self, *args):
        ...
        self.controllerTypeCombo.blockSignals(True)
        self.controllerTypeCombo.clear()
        self.controllerTypeCombo.addItems(list1)
        self.controllerTypeCombo.setCurrentIndex(-1)
        self.controllerTypeCombo.blockSignals(False)
        
        
        self.dockWidget.setVisible(False)
        self.dockWidget.setFloating(True)

        self.connect(self.controllerTypeCombo, SIGNAL('currentIndexChanged(const QString&)'), self.func_SwitchType)
    ...
    def func_SwitchType(self):
        currentType = self.controllerTypeCombo.currentIndex();
        pprint(currentType)
        self.stackedWidget.setCurrentIndex(currentType)
