...
if __name__ == '__main__':
  ...
  print "Will use '"+shared.ROOT.split()[0]+"' for root actions"  # @UndefinedVariable

  shared.init_config(None)
  shared.editProfile = ""

  shared.app = QApplication(sys.argv)
  if (shared.Globals.close_to_tray): shared.app.setQuitOnLastWindowClosed(False)  # @UndefinedVariable
  ...
  if (shared.Globals.start_minimized and shared.Globals.systray_enabled):
      ...
      gui.show()
  gui.show()
  shared.app.exec_()  # @UndefinedVariable
